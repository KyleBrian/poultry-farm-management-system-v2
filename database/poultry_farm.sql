...
--
-- Host: localhost
-- Generation Time: Mar 17, 2025 at 10:25 AM
...
(1, 'admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin@example.com', 'System Administrator', 'admin', '1234567890', 'active', NULL, '2025-03-17 09:25:36');
...
(1, 'FL-2025-001', 'Leghorn', 'Batch A', 500, '2025-01-15', 1, 'ABC Hatchery', '25000.00', 'Initial flock', 'active', 1, '2025-03-17 09:25:36');
...
(1, 1, '2025-03-01', 450, 5, 50, 200, 150, 45, 'Good production day', 1, '2025-03-17 09:25:36');
...
CREATE TABLE `feed_inventory` (
  ...
  `feed_type_id` int(11) NOT NULL,  -- Added this column to fix the error
...
INSERT INTO `feed_inventory` (`id`, `feed_type`, `feed_type_id`, `batch_number`, `quantity`, `unit`, `purchase_date`, `expiry_date`, `cost_per_unit`, `supplier`, `notes`, `created_by`, `created_at`) VALUES
(1, 'Starter Feed', 1, 'FEED-001', '500.00', 'kg', '2025-01-10', '2025-04-10', '2.50', 'Feed Supplier Inc.', 'Initial feed inventory', 1, '2025-03-17 09:25:36');
